...
public class SetVarUnitBuilder {
  private FieldCodeUnit codeUnit;

  private SetVarUnitBuilder() {
  ...
  public static SetVarUnitBuilder createWithIdentifier(String identifier) {
    SetVarUnitBuilder cub = new SetVarUnitBuilder();
  ...
  public SetVarUnitBuilder withDataType(String typeName) {
