...
public class PublicStaticMethodUnitBuilder {
  private MethodCodeUnit codeUnit;

  private PublicStaticMethodUnitBuilder() {
  ...
  public PublicStaticMethodUnitBuilder withMethodBody(String code) {
    this.codeUnit.addSubCodeUnit(DefaultCodeUnitProvider.createMethodBodyCodeUnit(code));
    return this;
  }

  public PublicStaticMethodUnitBuilder withReturnType(String typeName) {
    this.codeUnit.addCodeUnitDatum(CodeUnitDatumType.RETURN_TYPE, typeName);
    return this;
  }

  public PublicStaticMethodUnitBuilder withParameter(String identifier, String typeName) {
