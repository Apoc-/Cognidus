...
public class MethodModParamUnitBuilder {
  ...
  public MethodModParamUnitBuilder withReturnType(Class dataType) {
  ...
  public MethodModParamUnitBuilder addParameter(String identifier, Class type) {
    this.codeUnit.addSubCodeUnit(CodeUnitBuilderUtils.createMethodParameterCodeUnit(identifier, type));
    return this;
  }
}
