...
public class PublicMethodUnitBuilder {
  private MethodCodeUnit codeUnit;

  private PublicMethodUnitBuilder() {
  ...
  public static PublicMethodUnitBuilder createWithIdentifier(String identifier) {
    PublicMethodUnitBuilder cub = new PublicMethodUnitBuilder();
  ...
  public PublicMethodUnitBuilder withMethodBody(String code) {
    this.codeUnit.addSubCodeUnit(DefaultCodeUnitProvider.createMethodBodyCodeUnit(code));
    return this;
  }

  public PublicMethodUnitBuilder withReturnType(String typeName) {
    this.codeUnit.addCodeUnitDatum(CodeUnitDatumType.RETURN_TYPE, typeName);
    return this;
  }

  public PublicMethodUnitBuilder withParameter(String identifier, String typeName) {
